...
public aspect Observer {
	...
	/**
	 * Sirve para la recuperación de color, de los colores al momento de cambiar
	 */
	...
	after() : observer(){
		...
		//Verfica si ha dado un cambio de color
	...
	/**
	 * Sirve para obtener el número de veces que ha cambiado de color la pantalla 
	 */
	...
	before() : mostrarNumCambios(){
		Sistema sist = (Sistema) thisJoinPoint.getThis();
		System.out.println("+--------------------------------------------------------------+");
		System.out.println("|Se cambio el color de la pantalla "+sist.getContador()+" veces                     |");
		System.out.println("+--------------------------------------------------------------+");
	}
	...
	public String darColor(Color color) {
		...
		if(color.equals(new Color(0,255,0))){newColor = "Verde";}
		if(color.equals(new Color(255,200,0))){newColor = "Naranja";}
		if(color.equals(new Color(255,255,255))){newColor = "Blanco";}	
		return newColor;
	}
}
